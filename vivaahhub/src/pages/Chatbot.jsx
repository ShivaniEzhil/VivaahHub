...
const Chatbot = () => {
  ...
  useEffect(() => {
    ...
    if (savedMessages.length > 0) {
      ...
      const welcomeMessage = {
        sender: 'bot',
        text: 'Welcome to VivaahHub Chat! How can I assist you with your wedding today?',
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await axios.post(`${PUBLIC_API_URL}/chatbot`, { query: input });
      const botMessage = {
        sender: 'bot',
    ...
    <div className="wedding-chatbot-page">
      <div className="wedding-chatbot-container">
        <div className="wedding-chatbot-header">
          ...
          <h1>VivaahHub Chat Assistant</h1>
